...
export const PROVIDERS = {
  ...
  cohere: {
    ...
    models: [
      ...
      { id: 'command-a-plus-05-2026', name: '🧠 Command-A+ 218B (Paling Pintar)' },
      { id: 'command-r-plus-08-2024', name: '💪 Command-R+ (RAG & Tool Use)' },
      { id: 'command-r-08-2024', name: '⚡ Command-R (Budget, Cepat)' },
      { id: 'command-r7b-12-2024', name: '🚀 Command-R7B (Ultra Cepat)' },
      { id: 'c4ai-aya-vision-3-8b', name: '👁️ Aya Vision 8B (Gambar+Text)' },
      { id: 'c4ai-aya-expanse-3-8b', name: '🌍 Aya Expanse 8B (23 Bahasa)' },
      { id: 'c4ai-aya-expanse-3-32b', name: '🌍 Aya Expanse 32B (23 Bahasa)' },
      { id: 'cohere/north-mini-code:free', name: '💻 North Mini Code (Agentic Coding)' },
    ],
